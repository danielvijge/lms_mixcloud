...
$prefs->init({ apiKey => "", playformat => "mp4", useBuffered => 1, helper_application => 'bundled', helper_application_custom_path => "", streamingQuality_hls_192 => 1, streamingQuality_hls_64 => 0 });
